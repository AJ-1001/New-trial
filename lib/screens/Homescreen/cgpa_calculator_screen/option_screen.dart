import 'package:eduwisep/theme/theme_helper.dart';
              ...
              children: [
                ElevatedButton(
                  ...
                  style: ElevatedButton.styleFrom(
                    ...
                    backgroundColor: _buttonColor(0),
                ...
                ElevatedButton(
                  ...
                  style: ElevatedButton.styleFrom(
                    foregroundColor: Colors.white,
                    backgroundColor: _buttonColor(1),
                    minimumSize: const Size(150, 60),
                  ),
          ...
          child: Column(
            ...
            children: <Widget>[
                      ...
                      Expanded(
                        child: TextField(
                          ...
                          onChanged: (value) {
                            ...
                            if (value.isNotEmpty) {
                              filledFields =
                                  sgpaList.where((sgpa) => sgpa != 0.0).length;
                            } else {
                              filledFields = 0;
                            }
                          },
              ...
              ElevatedButton(
                onPressed: () {
                  double totalSGPA =
                      sgpaList.reduce((value, element) => value + element);
