...
import 'package:eduwisep/widgets/custom_pin_code_text_field.dart';
...
class _VerifyMailScreenState extends State<VerifyMailScreen> {
  ...
  void sendOtp(BuildContext context) async {
    ...
    if (await EmailOTP.sendOTP(email: userData!['email']!) == true) {
            ...
            child: Column(
              ...
              children: [
                ...
                GestureDetector(
                    onTap: () async {
                      print(pinCode);
                      if (EmailOTP.verifyOTP(otp: pinCode) == true) {
